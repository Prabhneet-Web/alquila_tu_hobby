...
class adminScreen extends GetView<adminContrroller> {
              ...
              if (controller.showDrawer.value)
                Container(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding: scale.getPadding(top: 10, left: 10),
                        child: Row(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                  color: LightTheme.white,
                  borderRadius:
                      BorderRadius.circular(scale.getScaledWidth(20))),
              //height: scale.fh * .8,
              width: scale.fw,
              child: DataTable(
  ...
  Widget catScreen(BuildContext context, ScalingUtility scale) {
    return Center(
      child: Padding(
        padding: scale.getPadding(left: 30, right: 25, top: 20),
        child: Column(
          children: [
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Expanded(
            child: GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                ...
                childAspectRatio:
                    .69, // Aspect ratio of each item (width/height)
              ),
  ...
  adashboardScreen(ScalingUtility scale, BuildContext context) {
    return Center(
      child: Padding(
        padding: scale.getPadding(left: 25, right: 25, top: 20),
  ...
  userContainer(ScalingUtility scale, BuildContext context) {
    return Expanded(
        child: Container(
      margin: scale.getMargin(vertical: 17),
      padding: scale.getPadding(vertical: 20, horizontal: 20),
      decoration: BoxDecoration(
          color: LightTheme.white,
          borderRadius:
